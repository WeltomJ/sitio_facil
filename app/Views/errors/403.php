...
<div class="container py-5 text-center">
    <i class="fas fa-lock fa-4x mb-4" style="color:var(--sf-danger-text);opacity:.6;"></i>
    <p class="fw-bold mb-1" style="font-size:5rem;line-height:1;color:var(--sf-text-strong);">403</p>
    <h1 class="h3 fw-bold mb-2">Acesso negado</h1>
    <p class="text-muted mb-4">Você não tem permissão para acessar este recurso.</p>
